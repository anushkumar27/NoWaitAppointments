...
(function ($) {
    ...
    $.fn.eCalendar.defaults = {
        ...
        url: '',
        events: [
            // {title: 'Event 1', description: 'Enter description', datetime: new Date(2017, new Date().getMonth(), 11, 12)},
            // {title: 'Event 2', description: 'Enter description', datetime: new Date(2017, new Date().getMonth(), 11, 11)},
            // {title: 'Event 3', description: 'Enter description', datetime: new Date(2017, new Date().getMonth(), 12, 10)}
        ],
        firstDayOfWeek: 1
    };
